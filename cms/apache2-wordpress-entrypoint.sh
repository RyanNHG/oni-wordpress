...
wp --allow-root plugin install polylang --version=2.2.3 --activate
wp --allow-root plugin install admin-menu-editor --version=1.8 --activate

# Activate custom plugins (https://developer.wordpress.org/cli/commands/plugin/activate/)
wp --allow-root plugin activate publish-hook
